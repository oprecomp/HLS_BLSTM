...
#		test $$? = 1 # bypassing test
	@grep -A8 critical $(SOLUTION_DIR)*/$(SOLUTION_NAME)/$(SOLUTION_NAME).log & echo "WARNING: Original check bypassed to allow overclocking, please check critical path!"
	@echo "OK"
